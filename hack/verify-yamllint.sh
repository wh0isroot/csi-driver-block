...
helmPath=charts/latest/csi-driver-block/templates
...
for path in "deploy/*.yaml" "deploy/example/*.yaml" "deploy/example/block-provisioner/*.yaml" "deploy/example/cloning/*.yaml" "deploy/example/snapshot/*.yaml"
do
