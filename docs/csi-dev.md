...
$ git clone https://github.com/kubernetes-csi/csi-driver-block $GOPATH/src/github.com/kubernetes-csi/csi-driver-block
```

 - Build CSI driver
```console
$ cd $GOPATH/src/github.com/kubernetes-csi/csi-driver-block
$ make
```
...
```console
helm package charts/latest/csi-driver-block -d charts/latest/
```
...
```console
$ cd $GOPATH/src/github.com/kubernetes-csi/csi-driver-block
$ ./bin/blockplugin --endpoint unix:///tmp/csi.sock --nodeid CSINode -v=5 &
```
