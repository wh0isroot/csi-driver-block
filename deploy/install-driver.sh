...
kubectl apply -f $repo/rbac-csi-block.yaml
kubectl apply -f $repo/csi-block-driverinfo.yaml
kubectl apply -f $repo/csi-block-controller.yaml
kubectl apply -f $repo/csi-block-node.yaml
